...
{
    public class PlaylistCreatorNodeViewModel : BaseNodeViewModel
    {
     
        public PlaylistCreatorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override PlaylistCreatorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new PlaylistCreatorNodeModel();
            node.Position = pos;
