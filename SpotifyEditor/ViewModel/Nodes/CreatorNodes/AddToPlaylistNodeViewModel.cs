...
{
    public class AddToPlaylistNodeViewModel : BaseNodeViewModel
    {
     
        public AddToPlaylistNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override AddToPlaylistNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AddToPlaylistNodeModel();
            node.Position = pos;
