...
{
    public class DeleteFromPlaylistNodeViewModel : BaseNodeViewModel
    {
     
        public DeleteFromPlaylistNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override DeleteFromPlaylistNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new DeleteFromPlaylistNodeModel();
            node.Position = pos;
