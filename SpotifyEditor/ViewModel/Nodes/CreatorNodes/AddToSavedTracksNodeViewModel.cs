...
{
    public class AddToSavedTracksNodeViewModel : BaseNodeViewModel
    {
     
        public AddToSavedTracksNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override AddToSavedTracksNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AddToSavedTracksNodeModel();
            node.Position = pos;
