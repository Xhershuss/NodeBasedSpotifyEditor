...
{
    public class AddToQueueNodeViewModel : BaseNodeViewModel
    {
     
        public AddToQueueNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override AddToQueueNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AddToQueueNodeModel();
            node.Position = pos;
