...
{
    public class UserTopArtistsGeneratorNodeViewModel : BaseNodeViewModel
    {

        public UserTopArtistsGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override UserTopArtistsGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UserTopArtistsGeneratorNodeModel();
            node.Position = pos;
