...
{
    public class UserTopTracksGeneratorNodeViewModel : BaseNodeViewModel
    {

        public UserTopTracksGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override UserTopTracksGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UserTopTracksGeneratorNodeModel();
            node.Position = pos;
