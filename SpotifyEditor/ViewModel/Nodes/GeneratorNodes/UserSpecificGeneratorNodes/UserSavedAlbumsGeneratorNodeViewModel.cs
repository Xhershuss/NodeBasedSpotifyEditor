...
{
    public class UserSavedAlbumsGeneratorNodeViewModel : BaseNodeViewModel
    {

        public UserSavedAlbumsGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override UserSavedAlbumsGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UserSavedAlbumsGeneratorNodeModel();
            node.Position = pos;
