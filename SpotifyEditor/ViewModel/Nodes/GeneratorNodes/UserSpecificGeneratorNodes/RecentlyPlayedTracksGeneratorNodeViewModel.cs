...
{
    public class RecentlyPlayedTracksGeneratorNodeViewModel : BaseNodeViewModel
    {
     
        public RecentlyPlayedTracksGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override RecentlyPlayedTracksGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new RecentlyPlayedTracksGeneratorNodeModel();
            node.Position = pos;
