...
{
    public class CurrentUsersPlaylistsGeneratorNodeViewModel : BaseNodeViewModel
    {
     
        public CurrentUsersPlaylistsGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override CurrentUsersPlaylistsGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new CurrentUsersPlaylistsGeneratorNodeModel();
            node.Position = pos;
