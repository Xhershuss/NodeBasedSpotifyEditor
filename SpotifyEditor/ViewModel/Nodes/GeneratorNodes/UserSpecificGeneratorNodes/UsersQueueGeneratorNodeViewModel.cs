...
{
    public class UsersQueueGeneratorNodeViewModel : BaseNodeViewModel
    {

        public UsersQueueGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override UsersQueueGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UsersQueueGeneratorNodeModel();
            node.Position = pos;
