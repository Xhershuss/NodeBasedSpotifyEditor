...
{
    public class UserSavedTracksGeneratorNodeViewModel : BaseNodeViewModel
    {
     
        public UserSavedTracksGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override UserSavedTracksGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UserSavedTracksGeneratorNodeModel();
            node.Position = pos;
