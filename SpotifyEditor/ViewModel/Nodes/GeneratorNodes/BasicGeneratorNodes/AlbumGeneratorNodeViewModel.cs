...
{
    public class AlbumGeneratorNodeViewModel: BaseNodeViewModel
    {
     
        public AlbumGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override AlbumGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AlbumGeneratorNodeModel();
            node.Position = pos;
