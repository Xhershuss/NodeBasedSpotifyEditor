...
{
    public class TrackGeneratorNodeViewModel : BaseNodeViewModel
    {

        public TrackGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override TrackGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new TrackGeneratorNodeModel();
            node.Position = pos;
