...
{
    public class ArtistBatchGeneratorNodeViewModel : BaseNodeViewModel
    {

        public ArtistBatchGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override ArtistBatchGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new ArtistBatchGeneratorNodeModel();
            node.Position = pos;
