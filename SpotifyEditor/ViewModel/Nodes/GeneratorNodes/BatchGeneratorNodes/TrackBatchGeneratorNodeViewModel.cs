...
{
    public class TrackBatchGeneratorNodeViewModel : BaseNodeViewModel
    {

        public TrackBatchGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override TrackBatchGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new TrackBatchGeneratorNodeModel();
            node.Position = pos;
