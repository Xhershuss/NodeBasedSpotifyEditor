...
{
    public class ArtistsAlbumsGeneratorNodeViewModel: BaseNodeViewModel
    {
     
        public ArtistsAlbumsGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override ArtistsAlbumsGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new ArtistsAlbumsGeneratorNodeModel();
            node.Position = pos;
