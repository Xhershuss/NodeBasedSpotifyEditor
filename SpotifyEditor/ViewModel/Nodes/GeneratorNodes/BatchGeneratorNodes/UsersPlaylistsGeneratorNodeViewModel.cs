...
{
    public class UsersPlaylistsGeneratorNodeViewModel : BaseNodeViewModel
    {
     
        public UsersPlaylistsGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override UsersPlaylistsGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new UsersPlaylistsGeneratorNodeModel();
            node.Position = pos;
