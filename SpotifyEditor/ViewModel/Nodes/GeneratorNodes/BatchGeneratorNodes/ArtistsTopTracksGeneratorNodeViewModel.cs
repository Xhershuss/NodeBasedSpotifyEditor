...
{
    public class ArtistsTopTracksGeneratorNodeViewModel : BaseNodeViewModel
    {
     
        public ArtistsTopTracksGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override ArtistsTopTracksGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new ArtistsTopTracksGeneratorNodeModel();
            node.Position = pos;
