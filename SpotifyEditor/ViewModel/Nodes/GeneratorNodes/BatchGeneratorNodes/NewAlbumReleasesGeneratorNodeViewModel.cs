...
{
    public class NewAlbumReleasesGeneratorNodeViewModel : BaseNodeViewModel
    {

        public NewAlbumReleasesGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override NewAlbumReleasesGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new NewAlbumReleasesGeneratorNodeModel();
            node.Position = pos;
