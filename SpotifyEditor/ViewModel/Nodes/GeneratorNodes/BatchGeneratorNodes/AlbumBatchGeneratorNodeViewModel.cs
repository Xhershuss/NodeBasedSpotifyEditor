...
{
    public class AlbumBatchGeneratorNodeViewModel : BaseNodeViewModel
    {

        public AlbumBatchGeneratorNodeViewModel(Canvas canvas) : base(canvas)
        {

        }

        public override AlbumBatchGeneratorNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AlbumBatchGeneratorNodeModel();
            node.Position = pos;
