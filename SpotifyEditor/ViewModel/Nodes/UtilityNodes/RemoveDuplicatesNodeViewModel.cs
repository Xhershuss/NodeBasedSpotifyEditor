...
{
    public class RemoveDuplicatesNodeViewModel : BaseNodeViewModel
    {
     
        public RemoveDuplicatesNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override RemoveDuplicatesNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new RemoveDuplicatesNodeModel();
            node.Position = pos;
