...
{
    public class DurationFilterNodeViewModel : BaseNodeViewModel
    {
     
        public DurationFilterNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override DurationFilterNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new DurationFilterNodeModel();
            node.Position = pos;
