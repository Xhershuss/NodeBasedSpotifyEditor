...
{
    public class AlbumFilterNodeViewModel : BaseNodeViewModel
    {
     
        public AlbumFilterNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override AlbumFilterNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new AlbumFilterNodeModel();
            node.Position = pos;
