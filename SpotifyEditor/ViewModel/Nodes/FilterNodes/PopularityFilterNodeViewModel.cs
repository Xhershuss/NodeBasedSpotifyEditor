...
{
    public class PopularityFilterNodeViewModel : BaseNodeViewModel
    {
     
        public PopularityFilterNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override PopularityFilterNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new PopularityFilterNodeModel();
            node.Position = pos;
