...
{
    public class ArtistFilterNodeViewModel : BaseNodeViewModel
    {
     
        public ArtistFilterNodeViewModel(Canvas canvas) : base(canvas)
        {
            
        }

        public override ArtistFilterNodeModel CreateNode(System.Drawing.Point pos)
        {

            var node = new ArtistFilterNodeModel();
            node.Position = pos;
